...
CREATE TABLE IF NOT EXISTS api_keys (
    ...
    tier TEXT NOT NULL DEFAULT 'paygo' CHECK (tier IN ('paygo', 'starter', 'growth', 'scale', 'enterprise')),
    monthly_limit INTEGER NOT NULL DEFAULT 999999999,
...
CREATE TABLE IF NOT EXISTS subscriptions (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    api_key_id UUID REFERENCES api_keys(id) ON DELETE CASCADE,
    tier TEXT NOT NULL CHECK (tier IN ('paygo', 'starter', 'growth', 'scale', 'enterprise')),
