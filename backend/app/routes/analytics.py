...
def _compute_overview() -> dict:
    ...
    with ThreadPoolExecutor(max_workers=8) as pool:
        ...
        # Chain breakdown
        for chain in ("avalanche", "ethereum", "base", "linea", "polygon", "arbitrum", "optimism", "bsc", "scroll", "gnosis", "mantle", "celo", "monad", "abstract", "taiko", "megaeth", "skale", "xlayer", "soneium", "metis", "solana"):
    ...
    chain_counts = {c: results[f"chain_{c}"] for c in ("avalanche", "ethereum", "base", "linea", "polygon", "arbitrum", "optimism", "bsc", "scroll", "gnosis", "mantle", "celo", "monad", "abstract", "taiko", "megaeth", "skale", "xlayer", "soneium", "metis", "solana") if results.get(f"chain_{c}", 0) > 0}
