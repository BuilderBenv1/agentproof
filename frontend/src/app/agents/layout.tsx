...
export const metadata: Metadata = {
  ...
  description: "Browse, search, and filter 68,000+ AI agents scored across 24 chains. Real-time trust scores, tier rankings, and behavioral analysis on ERC-8004.",
  ...
  openGraph: {
    title: "AI Agent Explorer — Browse 68,000+ Scored Agents",
    description: "Browse and search AI agents with real-time trust scores across 24 chains.",
