...
const SECTIONS = [
  ...
  { title: "Multi-Chain Indexing", description: "Indexing across 14 chains — Avalanche, Ethereum, Base, Linea, Polygon, Arbitrum, Optimism, BSC, Scroll, Gnosis, Mantle, Celo, Monad, and Abstract — via deterministic CREATE2 deployments." },
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          { icon: Shield, label: "Chains", value: "14", sub: "AVAX · ETH · Base · Polygon + 10 more" },
